...
four main dashboards for quick viewing:
...
Key Features
Demographic Analysis: Visual breakdowns by gender, age group, and customer location.

Customer Segmentation: Insights on loyal, new, lost, and other customer segments.

Transaction Analysis: Daily, monthly, and age-based transaction summaries.

Profitability & Risk: Revenue and risk metrics, highlighting high and low-risk customer groups.
